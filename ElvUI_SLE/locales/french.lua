...
L["%sCtrl+Left Click|r a person's line to invite them."] = "%sCtrl+Clic gauche|r sur la ligne d'une personne pour l'inviter."
L["%sCtrl+Right Click|r a line to edit officer note."] = "%sCtrl+Clic droit|r sur une ligne pour éditer la note d'officier."
L["%sLeft Click|r a client service to hide it."] = "%sClic gauche|r sur un service client pour le masquer."
L["%sLeft Click|r a person's line to whisper them."] = "%sClic gauche|r sur la ligne d'une personne pour lui chuchoter."
L["%sLeft Click|r datatext panel to open friends list."] = "%sClic gauche|r sur le panneau de texte pour ouvrir la liste d'amis."
L["%sLeft Click|r datatext panel to open guild list."] = "%sClic gauche|r sur le panneau de texte pour ouvrir la liste de guilde."
L["%sRight Click|r a client service to set your BNet Broadcast."] = "%sClic droit|r sur un service client pour définir votre diffusion BNet."
L["%sRight Click|r a person's line that has a bnet broadcast icon to expand it."] = "%sClic droit|r sur la ligne d'une personne avec une icône de diffusion BNet pour l'agrandir."
L["%sRight Click|r datatext panel to customize."] = "%sClic droit|r sur le panneau de texte pour personnaliser."
L["%sShift+Left Click|r a person's line to perform a lookup."] = "%sShift+Clic gauche|r sur la ligne d'une personne pour effectuer une recherche."
L["%sShift+Right Click|r a line to edit public note."] = "%sShift+Clic droit|r sur une ligne pour éditer la note publique."
L["%sShift+Right Click|r a person's line to set a note for them."] = "%sShift+Clic droit|r sur la ligne d'une personne pour lui attribuer une note."
L["|cff9482c9Shadow & Light|r Installation"] = "Installation de |cff9482c9Shadow & Light|r"
L["About"] = "À propos de"
L["About/Help"] = "A propos/Aide"
L["Account Time Played"] = "Le temps joué sur le compte :"
L["Actionbar Autocast"] = "Autocast de la barre d'action"
L["Actionbar Proc"] = "Proc de la barre d'action"
...
L["AFK Message & Time"] = "Message & Temps d'AFK"
...
L["Alternate Resource"] = "Ressource Alternative"
...
L["Armor Set Gradient Texture Color"] = "Couleur de texture en dégradé de l'ensemble d'armure"
L["Armor Set"] = "Ensemble d'armure"
L["Armor"] = "Armure"
...
L["Auto Work Orders for Shipyard"] = "Commandes automatiques pour le chantier naval"
L["Auto Work Orders for Trading Post"] = "Commandes automatiques pour le comptoir"
L["Auto Work Orders for Warmill"] = "Commandes automatiques pour la forge de guerre"
...
L["Automatically plant seeds to the nearest tilled soil if one is not already selected."] = "Plante automatiquement des graines dans la parcelle de terre la plus proche si aucune n'est déjà sélectionnée."
L["Automatically queue maximum number of work orders available for Shipyard."] = "Met automatiquement en file le nombre maximum de commandes disponibles pour le chantier naval."
L["Automatically queue maximum number of work orders available for Trading Post."] = "Met automatiquement en file le nombre maximum de commandes disponibles pour le comptoir."
L["Automatically queue maximum number of work orders available for Warmill/Dwarven Bunker."] = "Met automatiquement en file le nombre maximum de commandes disponibles pour la forge de guerre/le bunker nain."
L["Automatically queue maximum number of work orders available when visiting respected NPC."] = "Met automatiquement en file le nombre maximum de commandes disponibles lors de la visite du PNJ respectif."
